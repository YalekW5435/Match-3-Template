...
void GameApp::LoadingThreadCompleted()
{
	...
	for (int i = 0; i < mAlteredImg->GetWidth() * mAlteredImg->GetHeight(); i++)
	{
		...
		ulong gray = (ulong)((float)red * 0.30f + (float)green * 0.59f + (float)blue * 0.11f);
