...
HOWEVER:
LEAVE EVERYTHING ALONE IN POPLIB.  As mentioned, this library is designed to help you build.  
I have already made a simulated loading progress widget already provided, and have the main loop set to jet, with a minimalist resource xml, and app construct already made.  there are sme residual comments that you are free to modify or add on or get rid of.  
If you do wish to add on to this, please keep this to the dev branch in *this* repository so this way I can easily keep track of changes.  
